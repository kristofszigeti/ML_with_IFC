...
output_path = Path("../data/output/features_dummy.csv") # output path of 'features_dummy.csv'
...
output_numerical_data_frame.to_csv(output_path, index=False) # outputs the numerical data frame to the 'features_dummy.csv' file in !only one! column
